...
/***/ "./src/js/componetns/language-switcher.js":
/*!************************************************!*\
  !*** ./src/js/componetns/language-switcher.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function languageSwitcher() {
  ...
  if (languageSwitcher) {
    var dropdownToggle = languageSwitcher.querySelector('.dropdown-toggle');
    var dropdownMenu = languageSwitcher.querySelector('.dropdown-menu');
      ...
      dropdownItems.forEach(function (item, index) {
        item.addEventListener('keydown', function (e) {
          if (e.key === 'ArrowDown') {
            ...
            e.preventDefault();
            var prevIndex = index === 0 ? dropdownItems.length - 1 : index - 1;
