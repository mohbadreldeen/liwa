...
?>
	<div class="header-language-switcher dropdown">
		...
		<button class="dropdown-toggle" type="button" aria-haspopup="true" aria-expanded="false">
			<!-- <?php if ( $active_lang && ! empty( $active_lang['country_flag_url'] ) ) : ?>
				<img src="<?php echo esc_url( $active_lang['country_flag_url'] ); ?>" alt="<?php echo esc_attr( $active_lang['native_name'] ); ?>" />
			<?php endif; ?> -->

			<svg width="24" height="24" viewBox="0 0 24 24" fill="#95684B">
			...
			<span><?php echo esc_html( $active_lang ? $active_lang['native_name'] : 'Language' ); ?></span>
