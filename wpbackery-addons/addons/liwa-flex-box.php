...
return [
    'name' => __('Liwa Flex Box', 'liwadates'),
    'description' => __('A flexible container that can hold any WPBakery elements with flexbox layout options', 'liwadates'),
    'base' => 'liwa_flex_box',
    'icon' => 'icon-wpb-layout_sidebar',
    'content_element' => true,
    'is_container' => true,
    'as_parent' => ['except' => []],
    'as_child' => ['only' => 'vc_row,vc_column,vc_column_inner,vc_row_inner,liwa_slider'],
    ...
    'params' => [
        ...
        [
            ...
            'param_name' => 'gap',
            'value' => '20',
            'description' => __('Space between flex items in pixels (default: 20)', 'liwadates'),
            'group' => __('Flex Settings', 'liwadates'),
        ],
        [
            'type' => 'dropdown',
